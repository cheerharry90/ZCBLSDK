#
#  Be sure to run `pod spec lint ZCBLSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "wangjiang"
  # s.authors            = { "wangjiang" => "wangjiang@zhongchebaolian.com" }
  # s.social_media_url   = "http://twitter.com/wangjiang"
